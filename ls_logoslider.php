...
?>
    <div class="lsp_main_slider">
        ...
        ?>
            <div class="lsp_slider_controls"><div id="lsp_next_btn_<?php echo $slider_id; ?>" class="lsp_next_btn">next</div> <div id="lsp_prev_btn_<?php echo $slider_id; ?>" class="lsp_prev_btn">prev</div></div>
        <?php
        }
        ?>
